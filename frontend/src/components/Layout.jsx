...
import { Home, Users, UserRoundSearch, Cpu, Database, LifeBuoy, Megaphone, Settings, Menu, X, LogOut } from "lucide-react";
...
const navItems = [
  ...
  { path: "/ha-users", icon: UserRoundSearch, label: "HA Users" },
