...
Management → **Client Guides** is a card-based content-management interface with drag/drop upload, create/edit, file replacement, publish/unpublish, featured toggle, all/selected-client assignment, preview, ordering, and confirmation-gated deletion. New content requires no code change or frontend rebuild.
...
## Visibility, featured guides, and assignments
